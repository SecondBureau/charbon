...
ActiveRecord::Schema.define(version: 20160620200501) do
  ...
  add_index "plugins_ecommerce_attributes", ["parent_id"], name: "index_plugins_ecommerce_attributes_on_parent_id", using: :btree
  add_index "plugins_ecommerce_attributes", ["site_id"], name: "index_plugins_ecommerce_attributes_on_site_id", using: :btree
  ...
  add_index "plugins_ecommerce_orders", ["payment_method_id"], name: "index_plugins_ecommerce_orders_on_payment_method_id", using: :btree
  add_index "plugins_ecommerce_orders", ["shipping_method_id"], name: "index_plugins_ecommerce_orders_on_shipping_method_id", using: :btree
  add_index "plugins_ecommerce_orders", ["site_id"], name: "index_plugins_ecommerce_orders_on_site_id", using: :btree
  add_index "plugins_ecommerce_orders", ["user_id"], name: "index_plugins_ecommerce_orders_on_user_id", using: :btree
  ...
  add_index "plugins_ecommerce_products", ["order_id"], name: "index_plugins_ecommerce_products_on_order_id", using: :btree
  add_index "plugins_ecommerce_products", ["product_id"], name: "index_plugins_ecommerce_products_on_product_id", using: :btree
  add_index "plugins_ecommerce_products", ["qty"], name: "index_plugins_ecommerce_products_on_qty", using: :btree
